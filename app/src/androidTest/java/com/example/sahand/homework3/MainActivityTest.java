...
public class MainActivityTest {
    ...
    public void notEighteen() {
        onView(withId(R.id.name_field)).perform(typeText("Steve L"));
        onView(withId(R.id.date_of_birth_field)).perform(typeText("02/10/1999"));
        onView(withId(R.id.email_field)).perform(typeText("jackson@gmail.com"));
